        ...
        <div class="col-12">
            ...
            <div class="card" style="background-color:rgba(255,255,255,0.95);">
                <div class="card-header color-header" style="background-color: #343a40;">
                    <h5 class="text-white" style="font-weight: bold;"> {!!trans('Compras') !!}</h5>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <div class="row">
                                ...
                                <tbody>
                                    @if (count($consult))
                                        ...
                                        <tr class="thead-light">
                                            ...
                                            <td>
                                                <a href="{{route('compras.detalle',$item->id)}}" class="btn btn-warning btn-xs"><i class="fas fa-eye"></i>Ver</a>
                                            </td> 
                                        </tr>
                                        @endforeach
                                    @endif
